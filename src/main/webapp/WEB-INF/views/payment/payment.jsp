        ...
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                ...
                <style>
                    ...
                    .method-card.active[data-method="COD"] {
                        border-color: #34a853;
                        background: #f0fbf3;
                    }

                    .method-card.active[data-method="COD"] i,
                    .method-card.active[data-method="COD"] span {
                        color: #34a853;
                    }

                    .method-card.active[data-method="BANKING"] {
                        border-color: var(--primary);
                        background: #e8f0fe;
                    }

                    .method-card.active[data-method="BANKING"] i,
                    .method-card.active[data-method="BANKING"] span {
                        color: var(--primary);
                    }

                    .method-card.active[data-method="MOMO"] {
                        border-color: var(--momo);
                        background: #fce4ec;
                    }

                    .method-card.active[data-method="MOMO"] i,
                    .method-card.active[data-method="MOMO"] span {
                        color: var(--momo);
                    }
                                ...
                                <%-- LOI --%>
                                    ...
                                    <%-- CHON PHUONG THUC --%>
                                        <c:if test="${success != true and empty alreadyPaid and empty error}">
                                            ...
                                            <div class="pay-card">
                                                <h5><i class="bi bi-credit-card me-2"></i>Chon phuong thuc thanh toan
                                                </h5>
                                                ...
                                                <form id="payForm"
                                                    ...
                                                    <div id="pane-COD" class="method-pane active">
                                                        <div class="text-center">
                                                            <i class="bi bi-truck text-success"
                                                                style="font-size:2.2rem;"></i>
                                                            <p class="fw-bold text-success mb-1 mt-2">Thanh toan khi
                                                                nhan hang (COD)</p>
                                                    ...
                                                    <div id="pane-BANKING" class="method-pane">
                                                        <div class="text-center">
                                                            <i class="bi bi-shield-check text-primary"
                                                                style="font-size:2.2rem;"></i>
                                                            <p class="fw-bold text-primary mb-1 mt-2">Thanh toan qua
                                                                PayOS (VietQR)</p>
                                                        </div>
                                                        <div class="redirect-note">
                                                            ...
                                                            <span>
                                                                ...
                                                                va noi dung chuyen khoan duoc dien san. Ho tro tat ca
                                                                ngan hang Viet Nam.
                                                            </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="pane-MOMO" class="method-pane">
                                                        <div class="text-center">
                                                            <i class="bi bi-wallet2"
                                                                style="font-size:2.2rem; color:var(--momo);"></i>
                                                            <p class="fw-bold mb-1 mt-2" style="color:var(--momo);">
                                                                Thanh toan online qua PayOS</p>
                                                        </div>
                                                        <div class="redirect-note momo">
                                                            ...
                                                            <span>
                                                                ...
                                                                So tien <strong>
                                                                    <fmt:formatNumber value="${order.totalAmount}"
                                                                        type="number" groupingUsed="true" />d
                                                                </strong> duoc dien san.
                                                            </span>
                                                        </div>
                                                    </div>

                                                    <button type="submit" id="btnPay" class="btn-pay cod">
                                                        <i class="bi bi-check-circle me-1"></i> Xac nhan &amp; Thanh
                                                        toan COD
                                                    </button>
                                                </form>
                                            </div>
