...
<div class="page-header">
    <h1 class="page-title">${isCreate ? 'Thêm danh mục' : ' Sửa danh mục'}</h1>
</div>
...
<!-- KHUNG BÁO LỖI -->
    ...
    <form action="/WebBanHang/admin/categories/${isCreate ? 'create' : category.categoryId}${isCreate ? '' : '/edit'}" method="POST">
        ...
        <div style="margin-bottom: 16px;">
            ...
            <textarea name="description" style="width: 100%; padding: 8px; border: 1px solid #d9d9d9; border-radius: 4px; min-height: 100px;">${category.description}</textarea>
        </div>

        <div style="display: flex; gap: 12px;">
            <a href="/WebBanHang/admin/categories" style="padding: 8px 16px; background: #d9d9d9; border: none; border-radius: 4px; cursor: pointer; text-decoration: none; color: #333;"> Hủy</a>
