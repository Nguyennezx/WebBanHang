            ...
            <style>
                * {
                ...
                .admin-wrapper {
                    ...
                    /* DÒNG PHÉP THUẬT SẼ ÉP CÁI HEADER NHỎ LẠI */
                    min-height: 100vh;
                }
            ...
            <div class="admin-wrapper">
                ...
                <aside class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        <li><a href="/WebBanHang/admin/dashboard" class="active"><span
                        ...
                        <li><a href="/WebBanHang/admin/users"><span class="icon">👥</span>Người Dùng</a></li>
