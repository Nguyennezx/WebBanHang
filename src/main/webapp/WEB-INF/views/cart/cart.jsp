                                                        ...
                                                        <tr>
                                                            <%-- Ảnh sản phẩm --%>
                                                                ...
                                                                <%-- Tên sản phẩm --%>
                                                                    <td>
                                                                        <span
                                                                            class="product-name">${item.product.productName}</span>
                                                                    </td>
                                                                            ...
                                                                            <td>
                                                                                <form
                                                                                    ...
                                                                                    <button type="submit"
                                                                                        ...
                                                                                        value="${item.quantity + 1}"
                                                                                        <c:if
                                                                                        test="${item.product.quantityStock != null && item.quantity >= item.product.quantityStock}">disabled
                                                                                        </c:if>>+</button>
                                                                                </form>
                                                                            </td>
                            ...
                            <div class="modal-content">
                                <div class="modal-body">
                                    ...
                                    <p class="delete-confirm-text">
                                        B&#7841;n c&#243; mu&#7889;n x&#243;a
                                        <span class="delete-confirm-product" id="deleteProductName">s&#7843;n ph&#7849;m
                                            n&#224;y</span>
                                        kh&#7887;i gi&#7887; h&#224;ng kh&#244;ng?
                                    </p>
